...
echo "Please set the VNC password for user SAYK3"
su - SAYK3 -c vncpasswd
...
vnc_user_config="/home/SAYK3/.vnc/config"
...
touch /home/SAYK3/.vnc/config
chmod 766 /home/SAYK3/.vnc/config
echo "
geometry=1366x768
" > /home/SAYK3/.vnc/config
restorecon -rv /home/SAYK3/.vnc
...
red='\033[0;31m'
NC='\033[0m' # No Color
echo -e "${red}Display number for user SAYK3 is ${sessions[0]}${NC}"
